...
$barak = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=3&pId=1d1a7f13-2387-44d8-894a-5e3a310fefc2&Origin=Android&NearestStoreLocation=&ChildDOB=&CustomerLatitude=&CustomerLongitude=&StoreCode=TKHU&StoreCodeDest=");
$cek = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetMyCartCount?cartId=".$ridbc."&customerId=".$id);
$barak = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=5&pId=7e45275d-9222-43e9-8d46-0864877e3e77&Origin=Android&NearestStoreLocation=&ChildDOB=");
$ceki = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetMyCartCount?cartId=".$ridbc."&customerId=".$id);
$baraki = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=6&pId=c0ce410e-4b36-4c9d-b48c-f32ac98c26bf&Origin=Android&NearestStoreLocation=&ChildDOB=&CustomerLatitude=&CustomerLongitude=&StoreCode=TKHU&StoreCodeDest=");
