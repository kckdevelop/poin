...
$pilih = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetStoreAttributesFromStoreCode?StoreCodes=TEUP");
$pilih = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetStoreAttributesFromStoreCode?StoreCodes=TEUP&StoreCodeDest=&CustomerID=".$id);
$data = '{"CustomerID":"'.$id.'","AddressType":0,"StoreCode":"TEUP"}';
...
$barak = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=1&pId=1d1a7f13-2387-44d8-894a-5e3a310fefc2&Origin=Android&NearestStoreLocation=&ChildDOB=&CustomerLatitude=&CustomerLongitude=&StoreCode=TEUP&StoreCodeDest=");
$cek = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetMyCartCount?cartId=".$ridbc."&customerId=".$id);
$barak = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=2&pId=a3f4e5a8-3638-47ea-8c3a-1119d78eef55&Origin=Android&NearestStoreLocation=&ChildDOB=&CustomerLatitude=&CustomerLongitude=&StoreCode=TEUP&StoreCodeDest=");
$cek = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetMyCartCount?cartId=".$ridbc."&customerId=".$id);
$barak = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=1&pId=31b7469b-e136-4c6a-90c3-02a552f718b0&Origin=Android&NearestStoreLocation=&ChildDOB=&CustomerLatitude=&CustomerLongitude=&StoreCode=TEUP&StoreCodeDest=");
$cek = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/GetMyCartCount?cartId=".$ridbc."&customerId=".$id);
...
$baraki = getRequestt("https://api.klikindomaret.com/api/ShoppingCart/ModifyCart?regionID=66430dfd-0211-47d3-9e74-165b28e1f284&scId=".$ridbc."&cId=".$id."&cartRef=mobile&mod=add&id=&isPair=false&mfp_id=".$rid."&qty=5&pId=c0ce410e-4b36-4c9d-b48c-f32ac98c26bf&Origin=Android&NearestStoreLocation=&ChildDOB=&CustomerLatitude=&CustomerLongitude=&StoreCode=TEUP&StoreCodeDest=");
